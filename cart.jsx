...
const defaultEndpoint = 'http://localhost:1337/api/products'
...
const Products = (props) => {
  ...
  const [query, setQuery] = useState(defaultEndpoint)
  const [{ data, isLoading, isError }, doFetch] = useDataApi(defaultEndpoint, {
    data: [],
  })
